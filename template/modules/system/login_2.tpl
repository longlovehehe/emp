            ...
            <div class="login animated ">
                ...
                <form id="login1" action="?m=login_check" method="post">
                    <section class="login">
                        ...
                        <label><span class="title">{"密码"|L}：</span> <input autocomplete="off"  placeholder="{'输入密码'|L}" type="password" required="true" name="password" class="autosend"/></label>
